...
public class ScriptEngineBinder {
   ...
   public static final class LogWrapper {
      ...
      // Overloads commonly used in scripts; safe no-ops for Throwable are provided.
      public void info(String msg, Throwable t) {
         delegate.info(msg, t);
         addSpanLogEvent("INFO", msg, t);
      }

      public void debug(String msg, Throwable t) {
         delegate.debug(msg, t);
         addSpanLogEvent("DEBUG", msg, t);
      }

      public void warn(String msg, Throwable t) {
         delegate.warn(msg, t);
         addSpanLogEvent("WARN", msg, t);
      }
